...
public sealed class StageManager : MonoBehaviour
{
    ...
    {
        GameManager.instance.StartRecordPlayTime();

        var stageInfo = GameManager.instance.gameInfo.levelInfo.stageInfos[stageSceneCode];
        ...
        GameManager.instance.StopRecordPlayTime();
    }
