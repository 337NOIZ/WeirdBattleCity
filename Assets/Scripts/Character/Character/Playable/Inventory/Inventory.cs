...
public class Inventory : MonoBehaviour
{
    ...
    public void Initialize(Player player)
    {
        ...
        itemInfos = player.playerInfo.inventoryInfo.itemInfos;

        currentItemNumber = player.playerInfo.inventoryInfo.lastItemNumber;
        ...
        for (int index = 0; index < length; ++index)
        {
            ...
            consumables[index].Initialize(player);
        }
        ...
        for (int index = 0; index < length; ++index)
        {
            ...
            weapons[index].Initialize(player);
        }
    ...
    public bool GetItem(ItemInfo itemInfo)
    {
        ...
        if(index >= 0)
        {
            int stackCount_Max = Mathf.FloorToInt(GameManager.instance.itemDatas[itemInfo.itemCode].stackCount_Max * itemInfo.stackCount_Max_Multiple);
    ...
    private IEnumerator _Consum(bool draw)
    {
        ...
        yield return currentItem[ItemType.consumable].Consum();
    ...
    {
        currentItem[ItemType.consumable].StopConsum();
    }
    ...
    public void Attack(bool state)
    {
        ...
        {
            StartCoroutine(currentItem[ItemType.weapon].StopAttack(true));
        }
    }
    ...
    {
        yield return currentItem[ItemType.weapon].Attack();
    ...
    private IEnumerator _Reload()
    {
        if(_attack != null)
        {
            yield return currentItem[ItemType.weapon].StopAttack(false);
        }
