...
public class AudioMaster : MonoBehaviour
{
    ...
    {
        if(audioClips.ContainsKey(BackgroundMusicName) == true)
        {
    ...
    public void FadeAudioListenerVolume(float virtualAudioListenerVolume, float targetAudioListenerVolume, float fadeTime)
    {
        StopFadeAudioListenerVolume();

        _fadeAudioListenerVolume = _FadeAudioListenerVolume(virtualAudioListenerVolume, targetAudioListenerVolume, fadeTime);

        StartCoroutine(_fadeAudioListenerVolume);
    }

    public void FadeAudioListenerVolume(float targetAudioListenerVolume, float fadeTime)
    {
        FadeAudioListenerVolume(AudioListener.volume, targetAudioListenerVolume, fadeTime);
    }
    ...
    private IEnumerator _FadeAudioListenerVolume(float virtualAudioListenerVolume, float targetAudioListenerVolume, float fadeTime)
    {
        ...
        if (fadeTime > 0f)
        {
            float maxDelta = (virtualAudioListenerVolume >= targetAudioListenerVolume ? virtualAudioListenerVolume - targetAudioListenerVolume : targetAudioListenerVolume - virtualAudioListenerVolume) / fadeTime;
